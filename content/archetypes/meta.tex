...
\note{
    \begin{itemize}
				\item $t_-1$: Data reception starts. Concatenated in order of arrival. Any user should try to tweet as close to $t_0$ as possible to make sure $t_0$ is the deadline.
