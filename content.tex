...
\begin{document}
  ...
  \maketitle
	\note{
		\begin{itemize}
			\item International Association for Cryptologic Research (IACR)
			\begin{itemize}
				\item Just in their web archieve, where authors uploaded themselves.
				\item No peer-review or any convoluted submitting process.
			\end{itemize}
  ...
  \end{frame}
	...
	\begin{frame}{Scalability of Bitcoin --- Previous Efforts}
		...
		%\begin{minipage}{.47\textwidth}
			\includegraphics[height=.70\textheight]{figures/conjoined-triangle-of-success.pdf}
		%\end{minipage}\hfill%
  ...
  \end{frame}
	...
	\begin{frame}{Key Contributions}
		...
		\begin{minipage}{.52\textwidth}
			\includegraphics[width=1\textwidth]{figures/conjoined-triangle-of-success-omniledger.pdf}
		\end{minipage}\hfill%
  ...
  \section{Key Ideas}
	...
	\begin{frame}{Parallel Consensus Algorithm}
		\centering
		\includegraphics[height=.50\textheight]{figures/dag.pdf}
	\end{frame}
	\note{
		\begin{itemize}
			\item The idea:
...
\begin{frame}{Sharding and Atomic Commits}
	...
	\begin{frame}{Compact State Blocks (``Checkpoints'')}
		\centering
		\includegraphics[height=.70\textheight]{figures/one-shard.pdf}
	\end{frame}
	\note{
		\begin{itemize}
			\item The idea:
	...
	\begin{frame}{Evaluation --- Throughput}
		\centering
		\includegraphics[height=.9\textheight]{figures/results-tpsoptimal.pdf}
	\end{frame}
	\note{
		\begin{itemize}
	...
	\begin{frame}{Evaluation --- Latency}
		\centering
    \includegraphics[height=.8\textheight]{figures/results-latency-pdf.pdf}
  \end{frame}
	\note{
		\begin{itemize}
	...
	\begin{frame}{Evaluation --- Bootstrapping Bandwidth}
		\centering
		\includegraphics[height=.75\textheight]{figures/results-bootstrapping.pdf}
	\end{frame}
	\note{
		\begin{itemize}
  ...
  \end{frame}
    ...
    Visa-level throughput and only seconds of latency\\
		\vspace{.75cm}
		\includegraphics[width=0.8\textheight]{figures/conjoined-triangle-of-success-omniledger.pdf}
  \end{frame}
